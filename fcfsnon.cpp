/*.................C++ Program to Implement FCFS ( First Come First Serve ) CPU
SCheduling Algorithm..................... FCFS - A Non Preemptive Algorithm This
...
public:
  ...
  int ct, wt, tat, rt,
      start_time; // Completion, waiting, turnaround, response time
};                // Array of structure to store the info of each process.
...
bool comparatorPID(process_struct a, process_struct b) {
  int x = a.pid;
  int y = b.pid;
  return x < y;
}
